...
export const STEP_METADATA: Record<string, StepMetadata> = {
  ...
  [StepEnum.SYNTHESIS.toLowerCase()]: { label: 'Synth', icon: 'ri-node-tree', path: StepEnum.SYNTHESIS, showInSidebar: true, group: 'run' },
  [StepEnum.FLOORPLAN.toLowerCase()]: { label: 'Floor', icon: 'ri-layout-4-line', path: StepEnum.FLOORPLAN, showInSidebar: true, group: 'run' },
  [StepEnum.NETLIST_OPT.toLowerCase()]: { label: 'Fanout', icon: 'ri-share-line', path: StepEnum.NETLIST_OPT, showInSidebar: false, group: 'run' },
  ...
  [StepEnum.LEGALIZATION.toLowerCase()]: { label: 'Legal', icon: 'ri-check-double-line', path: StepEnum.LEGALIZATION, showInSidebar: false, group: 'run' },
